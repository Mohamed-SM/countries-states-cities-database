...
foreach($countriesArray as $country) :
    ...
    $sql = "SELECT id FROM countries WHERE iso2='".$country['code']."' LIMIT 1";
        ...
        while($row = $result->fetch_assoc()) {
            ...
            if (!empty($statesArray)) :
                foreach($statesArray as $state) :
                    ...
                    $sql = "SELECT id FROM regions WHERE country_id=".$country_id." AND name='".$state_name."'";
                    ...
                    if (!empty($result) && $result->num_rows > 0) { // If Found Update It
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $sql = "UPDATE regions SET name='".$state_name."' WHERE id=".$row['id'];
                        ...
                        $sql = "INSERT INTO regions (name, fips_code, iso2, country_id, created_at, wikiDataId) VALUES ('$name', '$fipsCode', '$isoCode', '$country_id', NOW(), '$wikiDataId')";
